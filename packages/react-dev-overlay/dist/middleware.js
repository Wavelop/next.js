...
__createBinding(exports, nodeStackFrames_1, "getErrorSource");
var nodeStackFrames_2 = require("./internal/helpers/nodeStackFrames");
__createBinding(exports, nodeStackFrames_2, "decorateServerError");
__createBinding(exports, nodeStackFrames_2, "getServerError");
...
function getModuleById(id, compilation) {
    return __spreadArray([], __read(compilation.modules), false).find(function (searchModule) { return getModuleId(compilation, searchModule) === id; });
}
function findModuleNotFoundFromError(errorMessage) {
    var match = errorMessage === null || errorMessage === void 0 ? void 0 : errorMessage.match(/'([^']+)' module/);
...
function findOriginalSourcePositionAndContentFromCompilation(modulePath, importedModule, compilation) {
    var _a, _b, _c;
    var module = getModuleById(modulePath, compilation);
    return (_c = (_b = (_a = module === null || module === void 0 ? void 0 : module.buildInfo) === null || _a === void 0 ? void 0 : _a.importLocByPath) === null || _b === void 0 ? void 0 : _b.get(importedModule)) !== null && _c !== void 0 ? _c : null;
}
function createOriginalStackFrame(_a) {
    var _b, _c, _d;
    var line = _a.line, column = _a.column, source = _a.source, modulePath = _a.modulePath, rootDirectory = _a.rootDirectory, frame = _a.frame, errorMessage = _a.errorMessage, compilation = _a.compilation;
    return __awaiter(this, void 0, void 0, function () {
        var moduleNotFound, result, _e, sourcePosition, sourceContent, filePath, originalFrame, originalCodeFrame;
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    moduleNotFound = findModuleNotFoundFromError(errorMessage);
                    if (!moduleNotFound) return [3 /*break*/, 1];
                    _e = findOriginalSourcePositionAndContentFromCompilation(modulePath, moduleNotFound, compilation);
                    return [3 /*break*/, 3];
                case 1: return [4 /*yield*/, findOriginalSourcePositionAndContent(source, {
                        line: line,
                        column: column
                    })];
                case 2:
            ...
            switch (_a.label) {
                ...
                case 2:
                    try {
                        ...
                        module_1 = getModuleById(id, compilation);
...
function getOverlayMiddleware(options) {
    return function (req, res, next) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var _s, pathname, query, frame, moduleId, source, compilation, err_1, frameLine, frameColumn, originalStackFrameResponse, err_2, frame, frameFile, filePath, fileExists, frameLine, frameColumn, err_3;
            return __generator(this, function (_t) {
                switch (_t.label) {
                    case 0:
                        _s = url_1["default"].parse(req.url, true), pathname = _s.pathname, query = _s.query;
                        ...
                        source = void 0;
                        compilation = frame.isEdgeServer === 'true'
                            ? (_e = options.edgeServerStats()) === null || _e === void 0 ? void 0 : _e.compilation
                            : frame.isServer === 'true'
                                ? (_f = options.serverStats()) === null || _f === void 0 ? void 0 : _f.compilation
                                : (_g = options.stats()) === null || _g === void 0 ? void 0 : _g.compilation;
                        _t.label = 1;
                    case 1:
                        _t.trys.push([1, 3, , 4]);
                    ...
                    case 4:
                        ...
                        frameLine = parseInt((_j = (_h = frame.lineNumber) === null || _h === void 0 ? void 0 : _h.toString()) !== null && _j !== void 0 ? _j : '', 10);
                        frameColumn = parseInt((_l = (_k = frame.column) === null || _k === void 0 ? void 0 : _k.toString()) !== null && _l !== void 0 ? _l : '', 10);
                        if (!frameColumn) {
                            frameColumn = null;
                        }
                        _t.label = 5;
                    ...
                    case 6:
                        originalStackFrameResponse = _t.sent();
                    ...
                    case 9:
                        ...
                        frame = query;
                        frameFile = ((_m = frame.file) === null || _m === void 0 ? void 0 : _m.toString()) || null;
                        if (frameFile == null) {
                            res.statusCode = 400;
                            res.write('Bad Request');
                            return [2 /*return*/, res.end()];
                        }
                        filePath = path_1["default"].resolve(options.rootDirectory, frameFile.replace(/^\([^)]+\)\//, ''));
                    ...
                    case 10:
                        ...
                        frameLine = parseInt((_p = (_o = frame.lineNumber) === null || _o === void 0 ? void 0 : _o.toString()) !== null && _p !== void 0 ? _p : '', 10) || 1;
                        frameColumn = parseInt((_r = (_q = frame.column) === null || _q === void 0 ? void 0 : _q.toString()) !== null && _r !== void 0 ? _r : '', 10) || 1;
                        _t.label = 11;
                    case 11:
