...
var Errors = function Errors(_a) {
    ...
    var _d = __read(React.useState('fullscreen'), 2), displayState = _d[0], setDisplayState = _d[1];
    ...
    var hide = React.useCallback(function (e) {
        e === null || e === void 0 ? void 0 : e.preventDefault();
        setDisplayState('hidden');
    }, []);
    var fullscreen = React.useCallback(function (e) {
        e === null || e === void 0 ? void 0 : e.preventDefault();
    ...
    if (displayState === 'minimized') {
        return (React.createElement(Toast_1.Toast, { className: "nextjs-toast-errors-parent", onClick: fullscreen },
            React.createElement("div", { className: "nextjs-toast-errors" },
                ...
                React.createElement("button", { "data-nextjs-toast-errors-hide-button": true, className: "nextjs-toast-errors-hide-button", type: "button", onClick: function (e) {
                        e.stopPropagation();
                        hide();
                    }, "aria-label": "Hide Errors" },
                    React.createElement(CloseIcon_1.CloseIcon, null)))));
    }
    var isServerError = ['server', 'edge-server'].includes((0, nodeStackFrames_1.getErrorSource)(activeError.error) || '');
    return (React.createElement(Overlay_1.Overlay, null,
