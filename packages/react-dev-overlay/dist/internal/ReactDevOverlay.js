...
function reducer(state, ev) {
    switch (ev.type) {
        ...
        case Bus.TYPE_UNHANDLED_REJECTION: {
            return __assign(__assign({}, state), { nextId: state.nextId + 1, errors: __spreadArray(__spreadArray([], __read(state.errors.filter(function (err) {
...
var ReactDevOverlay = function ReactDevOverlay(_a) {
    var children = _a.children, preventDisplay = _a.preventDisplay, globalOverlay = _a.globalOverlay;
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(ErrorBoundary_1.ErrorBoundary, { globalOverlay: globalOverlay, isMounted: isMounted, onError: onComponentError }, children !== null && children !== void 0 ? children : null),
        isMounted ? (React.createElement(ShadowPortal_1.ShadowPortal, { globalOverlay: globalOverlay },
            ...
            shouldPreventDisplay(hasBuildError ? 'build' : hasRuntimeErrors ? 'runtime' : null, preventDisplay) ? null : hasBuildError ? (React.createElement(BuildError_1.BuildError, { message: state.buildError })) : hasRuntimeErrors ? (React.createElement(Errors_1.Errors, { errors: state.errors })) : undefined)) : undefined));
};
