...
var ShadowPortal = function Portal(_a) {
    var children = _a.children, globalOverlay = _a.globalOverlay;
    ...
    React.useLayoutEffect(function () {
        var ownerDocument = globalOverlay
            ? document
    ...
    return shadowNode.current ? ((0, react_dom_1.createPortal)(children, shadowNode.current)) : globalOverlay ? null : (React.createElement("span", { ref: mountNode }));
};
